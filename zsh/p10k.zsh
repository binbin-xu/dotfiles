# Generated by Powerlevel10k configuration wizard on 2020-05-25 at 12:36 BST.
...
# darkest, 24h time, angled separators, sharp heads, blurred tails, 2 lines, solid,
...
() {
  ...
  typeset -g POWERLEVEL9K_ANACONDA_CONTENT_EXPANSION='py$P9K_ANACONDA_PYTHON_VERSION + ${${CONDA_PROMPT_MODIFIER#\(}%\) }'
